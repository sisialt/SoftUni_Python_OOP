...
class StudentTests(unittest.TestCase):
    ...
    def test_enroll_with_already_existed_course_update_notes(self):
    ...
    def test_add_notes_to_already_existed_course(self):
    ...
    def test_leave_course_not_existed_course_raises(self):
        with self.assertRaises(Exception) as ex:
